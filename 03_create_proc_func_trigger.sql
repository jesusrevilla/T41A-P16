...
-- Trigger: Auditoría de cambios en el stock

-- 1) Trigger para auditar cambios de stock
...
-- 2) Procedimiento: registrar_movimiento
--    - Valida tipo ('entrada'|'salida') y cantidad > 0
--    - Bloquea la fila del producto (FOR UPDATE)
--    - Evita stock negativo en 'salida'
--    - Actualiza productos.stock
--    - Inserta el movimiento en movimientos_inventario
...
-- 3) Función: calcular_valor_inventario
--    Devuelve el valor total (stock * precio_unitario) de todos los productos.
